...
import UIKit
import Charts
class LikesViewController: UIViewController, ChartViewDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        var entries = [
            ChartDataEntry(x:Double(1),y: Double(500)),
            ChartDataEntry(x:Double(1), y: Double(100))
        ]
        let set = PieChartDataSet(entries: entries, label: "Likes, Dislikes")
